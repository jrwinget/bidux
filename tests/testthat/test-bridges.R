# Test bridge functions - new for 0.3.1
# These tests compare bridge functions vs manual Notice creation
...
test_that("bid_notices processes multiple issues correctly", {
  ...
  interpret_stage <- bid_interpret(central_question = "How to improve overall UX?")
...
test_that("bid_address creates single Notice from issue", {
  ...
  interpret_stage <- bid_interpret(central_question = "How to address performance issues?")
