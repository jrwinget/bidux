...
**Note**: Bidux supports both `{shiny.telemetry}` and Shiny's native OpenTelemetry (v1.12+). The examples below work with either source; `{bidux}` automatically detects the format. For OpenTelemetry setup, see `vignette("opentelemetry-integration")`.
