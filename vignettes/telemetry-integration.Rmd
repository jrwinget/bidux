...
**New in v0.3.1:** Enhanced telemetry workflow with hybrid objects and streamlined API for better integration with tidy data workflows.

### Modern Telemetry API (v0.3.1+)
...
## Bridge Functions and Sugar Syntax (v0.3.1+)
...
Here's a full example analyzing a dashboard with multiple issues using the new v0.3.1 API:
