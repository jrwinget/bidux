...
First off, thank you for your interest in making
[bidux](https://jrwinget.github.io/bidux/) better! Whether you’re filing
a bug report, suggesting a new feature, improving documentation, or
submitting code, your contributions are what make this project great.

------------------------------------------------------------------------

## 📜 Code of Conduct

All contributors must abide by our [Contributor Code of
Conduct](https://jrwinget.github.io/bidux/CODE_OF_CONDUCT.md). Please
...
2.  If not, open a new issue using the **Bug Report** template:
    <https://github.com/jrwinget/bidux/issues/new?template=01_bug-report.yml>
3.  Fill in all sections, including reproducible examples and session
    info.
...
2.  Open a new issue with the **Feature Request** template:
    <https://github.com/jrwinget/bidux/issues/new?template=02_feature-request.yml>
3.  Describe the use case, proposed API, and any relevant links or
    mockups.
...
We rely on clear examples and comprehensive docs. To propose
improvements:

1.  Create an issue with the **Documentation** template:
    <https://github.com/jrwinget/bidux/issues/new?template=03_documentation-improvement.yml>
2.  Submit a PR with updated `.Rmd`, vignettes, or help files.
3.  Use `\donttest{}` for long-running examples, and ensure all code in
    examples runs without external dependencies.
...
**CI checks** will run automatically. Address any failures before
requesting a review.
...
- Run `styler::style_pkg()` and `lintr::lint_package()` to catch
  formatting issues.
...
- Use `skip_on_cran()` or `skip_on_ci()` for tests that require external
  resources.
...
- **Evidence-Based**: Cite reputable sources when introducing new
  theories.
...
For general questions, brainstorming, or design discussions, use [GitHub
...
**Thank you for helping [bidux](https://jrwinget.github.io/bidux/)
become stronger and more user-friendly!**
